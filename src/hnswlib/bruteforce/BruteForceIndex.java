package hnswlib.bruteforce;

import hnswlib.DistanceFunction;
import hnswlib.Index;
import hnswlib.Item;
import hnswlib.SearchResult;
import hnswlib.SearchResultTotal;
import hnswlib.util.ClassLoaderObjectInputStream;
...
public class BruteForceIndex<TId, TVector, TItem extends Item<TId, TVector>, TDistance>
	...
	@Override
	public List<String> searchParallel(TItem item, TDistance distance, AtomicLong visitedVertices, AtomicLong hops)
	{
